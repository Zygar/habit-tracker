These medicines should be labelled 'Shake the bottle', followed by specific instructions for administration. For example, 'Take x ml (DOSE) x times daily (FREQUENCY)'.
